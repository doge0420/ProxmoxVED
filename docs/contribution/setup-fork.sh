...
# upstream   https://github.com/ethan-hgwr/ProxmoxVED.git (fetch)
# upstream   https://github.com/ethan-hgwr/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/ethan-hgwr/ProxmoxVED"
echo ""
