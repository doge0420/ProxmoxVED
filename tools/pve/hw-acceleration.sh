...
# Repo: https://github.com/ethan-hgwr/ProxmoxVED
#
# Usage: bash -c "$(wget -qLO - https://github.com/ethan-hgwr/ProxmoxVED/raw/main/misc/hw-acceleration.sh)"
#
# Requires:
#   - Proxmox VE 8.1+
...
# https://github.com/ethan-hgwr/ProxmoxVED
...
source <(wget -qO- https://github.com/ethan-hgwr/ProxmoxVED/raw/main/tools/pve/gpu-nvidia.func)
source <(wget -qO- https://github.com/ethan-hgwr/ProxmoxVED/raw/main/tools/pve/gpu-intel.func)
source <(wget -qO- https://github.com/ethan-hgwr/ProxmoxVED/raw/main/tools/pve/gpu-amd.func)
