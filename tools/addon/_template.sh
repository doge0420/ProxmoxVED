...
source <(curl -fsSL https://raw.githubusercontent.com/ethan-hgwr/ProxmoxVED/main/misc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/ethan-hgwr/ProxmoxVED/main/misc/tools.func)
...
source <(curl -fsSL https://raw.githubusercontent.com/ethan-hgwr/ProxmoxVED/main/misc/tools.func) 2>/dev/null || {
